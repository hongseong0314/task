...
class MatrixAlgorithjeep:
    def __init__(self, agent):
        self.agent = agent
        self.machine_feature = None
    ...
    def __call__(self, state):
        ...
        if self.agent.skip:
            ...
            self.machine_feature = machine_feature.clone(); self.task_feature = task_feature.clone();
            self.D_TM = D_TM.clone(); self.ninf_mask = ninf_mask.clone();
            self.action = task_selected;
